...
public class Ship {
    ...
    public Type getType() {
        ...
        return type; // Agrega este método
    }
    ...
    public static Path getDraw(int ship){
        switch (ship) {
            case 4:   //frigate
            ...
            case 3:  //submarine
                Path submarinePath = new Path(
                        ...
                        new LineTo(26,8),
                        new LineTo(65,5),
                        new ArcTo(10, 10, 0, 65, 35, false, true),
                        new LineTo(26,33),
                        new LineTo(0,25),
                        new ClosePath(),
                        new MoveTo(6.25,13),
                        ...
                        new ClosePath(),
                        new MoveTo(67.25,15),
                        new ArcTo(5, 5, 0, 67.25, 25, false, true),
                        new LineTo(60.25, 25),
                        new ArcTo(5, 5, 0, 60.25, 15, false, true),
                        new ClosePath()
                );
            ...
            case 2:  //destroyer
                Path destroyerPath = new Path(
                        ...
                        new LineTo(10,0),
                        new LineTo(80,0),
                        new ArcTo(80, 100, 0, 120, 20, false, true),
                        new ArcTo(80, 100, 0, 80, 40, false, true),
                        new LineTo(10,40),
                        new LineTo(0,34),
                        new ClosePath(),
                        new MoveTo(15,6),
                        new LineTo(80,6),
                        new ArcTo(80, 100, 0, 110, 20, false, true),
                        new ArcTo(80, 100, 0, 80, 34, false, true),
                        new LineTo(9,34),
                        ...
                        new LineTo(15,22.5),
                        new ClosePath(),
                        new MoveTo(18.5,22.5),
                        new LineTo(18.5, 17.5),
                        new MoveTo(21.5,22.5),
                        new LineTo(21.5, 17.5),
                        new MoveTo(31,13.75),
                        new LineTo(48, 13.75),
                        new LineTo(48,26.25),
                        new LineTo(31,26.25),
